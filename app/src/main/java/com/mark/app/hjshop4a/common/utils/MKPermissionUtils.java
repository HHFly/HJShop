 ...
 */
public class MKPermissionUtils {

    private static final String TAG = MKPermissionUtils.class.getSimpleName();
    ...
    public MKPermissionUtils(Activity activity, Context context) {
