package com.mark.app.hjshop4a.widget.calendarview.weiget;
...
import com.mark.app.hjshop4a.widget.calendarview.bean.AttrsBean;
import com.mark.app.hjshop4a.widget.calendarview.bean.DateBean;
import com.mark.app.hjshop4a.widget.calendarview.listener.CalendarViewAdapter;
...
import com.mark.app.hjshop4a.widget.calendarview.listener.OnSingleChooseListener;
import com.mark.app.hjshop4a.widget.calendarview.utils.CalendarUtil;
import com.mark.app.hjshop4a.widget.calendarview.utils.SolarUtil;
...
public class CalendarView extends ViewPager {
    ...
    private void initAttr(Context context, AttributeSet attrs) {
        TypedArray ta = context.obtainStyledAttributes(attrs, com.mark.app.hjshop4a.R.styleable.CalendarView);
        for (int i = 0; i < ta.getIndexCount(); i++) {
            int attr = ta.getIndex(i);
            if (attr == com.mark.app.hjshop4a.R.styleable.CalendarView_show_last_next) {
                mAttrsBean.setShowLastNext(ta.getBoolean(attr, true));
            } else if (attr == com.mark.app.hjshop4a.R.styleable.CalendarView_show_lunar) {
                mAttrsBean.setShowLunar(ta.getBoolean(attr, true));
            } else if (attr == com.mark.app.hjshop4a.R.styleable.CalendarView_show_holiday) {
                mAttrsBean.setShowHoliday(ta.getBoolean(attr, true));
            } else if (attr == com.mark.app.hjshop4a.R.styleable.CalendarView_show_term) {
                mAttrsBean.setShowTerm(ta.getBoolean(attr, true));
            } else if (attr == com.mark.app.hjshop4a.R.styleable.CalendarView_switch_choose) {
                mAttrsBean.setSwitchChoose(ta.getBoolean(attr, true));
            } else if (attr == com.mark.app.hjshop4a.R.styleable.CalendarView_solar_color) {
                mAttrsBean.setColorSolar(ta.getColor(attr, mAttrsBean.getColorSolar()));
            } else if (attr == com.mark.app.hjshop4a.R.styleable.CalendarView_solar_size) {
                mAttrsBean.setSizeSolar(CalendarUtil.getTextSize(context, ta.getInteger(attr, mAttrsBean.getSizeSolar())));
            } else if (attr == com.mark.app.hjshop4a.R.styleable.CalendarView_lunar_color) {
                mAttrsBean.setColorLunar(ta.getColor(attr, mAttrsBean.getColorLunar()));
            } else if (attr == com.mark.app.hjshop4a.R.styleable.CalendarView_lunar_size) {
                mAttrsBean.setSizeLunar(CalendarUtil.getTextSize(context, ta.getInt(attr, mAttrsBean.getSizeLunar())));
            } else if (attr == com.mark.app.hjshop4a.R.styleable.CalendarView_holiday_color) {
                mAttrsBean.setColorHoliday(ta.getColor(attr, mAttrsBean.getColorHoliday()));
            } else if (attr == com.mark.app.hjshop4a.R.styleable.CalendarView_choose_color) {
                mAttrsBean.setColorChoose(ta.getColor(attr, mAttrsBean.getColorChoose()));
            } else if (attr == com.mark.app.hjshop4a.R.styleable.CalendarView_day_bg) {
                mAttrsBean.setDayBg(ta.getResourceId(attr, mAttrsBean.getDayBg()));
            } else if (attr == com.mark.app.hjshop4a.R.styleable.CalendarView_choose_type) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int calendarHeight;
        if (getAdapter() != null) {
            com.mark.app.hjshop4a.widget.calendarview.weiget.MonthView view = (com.mark.app.hjshop4a.widget.calendarview.weiget.MonthView) getChildAt(0);
            if (view != null) {
