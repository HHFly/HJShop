...
public class AlphaWebFragment extends BaseWebFragment {
     ...
     * @return
     */
    public static AlphaWebFragment getInstance(String url, String title) {
        AlphaWebFragment webFragment = new AlphaWebFragment();
    ...
    public int getContentResId() {
        return R.layout.fragment_web_alpha;
    }
