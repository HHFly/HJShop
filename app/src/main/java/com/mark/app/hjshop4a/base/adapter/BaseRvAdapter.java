...
public abstract class BaseRvAdapter extends RecyclerView.Adapter<AutoViewHolder> {

    BaseRvAdapter.RvAdapterCallback mCallback;
    protected MkViewHolder.OnItemClickListener mItemClickListener;

    public BaseRvAdapter() {
    }

    public void setCallback(BaseRvAdapter.RvAdapterCallback callback) {
