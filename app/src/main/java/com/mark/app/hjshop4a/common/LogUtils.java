...
public class LogUtils {
    ...
    public static void logFormat(Object obj, String method, String desc) {
        logFormat(obj, method, desc, mNormalFlag);
    }
     ...
     * @param desc
     */
    public static void logFormat(Object obj, String method, String desc, int flag) {
        if (isOpenLog) {
            String className = obj.getClass().getSimpleName();
            logFormat(className, method, desc, flag);
        }
    }
    ...
    public static void logFormat(String className, String method, String desc) {
        logFormat(className, method, desc, mNormalFlag);
    }
     ...
     * @param desc
     */
    public static void logFormat(String className, String method, String desc, int flag) {
        if (isOpenLog) {
